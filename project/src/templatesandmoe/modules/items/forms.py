...
class AddServiceForm(Form):
    name = StringField('Name', validators=[DataRequired(message='Name is required.')])
    start_price = FloatField('Start Price', validators=[NumberRange(min=1, message='Price must at least $1.00'), DataRequired(message='Start price is required.'), validate_price])
